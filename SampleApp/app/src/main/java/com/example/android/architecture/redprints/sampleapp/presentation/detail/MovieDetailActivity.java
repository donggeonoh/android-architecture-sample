...
public class MovieDetailActivity extends BaseActivity<ActivityMovieDetailBinding> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MovieDetailViewModel movieDetailViewModel = ViewModelProviders.of(this)
                .get(MovieDetailViewModel.class);
        binding.setVm(movieDetailViewModel);
        binding.webView.setWebViewClient(new WebViewClient());
        binding.webView.getSettings().setJavaScriptEnabled(true);
        movieDetailViewModel.setLinkUrl(getIntent().getStringExtra(EXTRA_LINK_URL));
    }
}
